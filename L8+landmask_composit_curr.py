...
def resolution_change(L8path, landmaskpath):
    ...
    mask = landmask.GetRasterBand(1).ReadAsArray().astype(float)
    ...
    #del dst_ds
resolution_change("C:/Users/rramirez.HBG-S1258/OneDrive - Science Systems and Applications, Inc/Documents/LC08_L1TP_002071_20181017_20181030_01_T1 (1).TIF", "C:/Users/rramirez.HBG-S1258/OneDrive - Science Systems and Applications, Inc/Documents/LC08_L1TP_002071_20181017_20181030_01_T1_landmask.tif")
